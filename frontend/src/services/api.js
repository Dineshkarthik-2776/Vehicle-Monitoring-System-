...
export const vehicleApi = {
  ...
  swap:       (current_pcb_id, new_pcb_id, VIN) => api.post('/vehicle/swap', { current_pcb_id, new_pcb_id, VIN }),
...
export const analyticsApi = {
  ...
  getDailyActivity: () => api.get('/analytics/daily-activity'),
  getPCBStatus:     () => api.get('/analytics/pcb-status'),
